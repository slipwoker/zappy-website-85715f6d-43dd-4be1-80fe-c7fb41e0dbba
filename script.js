    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      try {
        ...
        const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
          ...
          body: JSON.stringify({
            websiteId: '85715f6d-43dd-4be1-80fe-c7fb41e0dbba',
            name: data.name || '',
            email: data.email || '',
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בן צור יזמות וניהול נכסים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
